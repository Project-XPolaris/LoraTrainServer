...
def train(args):
    ...
    for epoch in range(num_train_epochs):
        instance.TaskPoolInstance.current_task.epoch = epoch + 1
        instance.TaskPoolInstance.current_task.total_epochs = num_train_epochs
        if is_main_process:
        ...
        for step, batch in enumerate(train_dataloader):
            if instance.TaskPoolInstance.current_task.interrupt:
                print("interrupted")
                return
            instance.TaskPoolInstance.current_task.steps = step + 1
            instance.TaskPoolInstance.current_task.total_steps = len(train_dataloader)
